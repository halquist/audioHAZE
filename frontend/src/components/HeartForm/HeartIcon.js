...
const HeartIcon = (hearted) => {

  return (
  <svg version="1.1" id={`heartIcon ${hearted}`} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
  width="96.338px" height="74.379px" viewBox="0 0 96.338 74.379" enableBackground="new 0 0 96.338 74.379">
